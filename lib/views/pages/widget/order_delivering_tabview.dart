...
class OrderDeliveringTabView extends GetView<OrderDeliveringController> {
  const OrderDeliveringTabView({super.key});

  @override
  Widget build(BuildContext context) {
    // controller.setDataTableDelivering(controller.initModelList);
